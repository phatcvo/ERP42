    ...
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            if self.is_path == True and self.is_status == True and self.is_global_path == True:                                      
                ...
                self.cruise_ctrl.checkObject(self.path, global_npc_info, local_npc_info ,global_ped_info, local_ped_info, global_obs_info, local_obs_info)                                                 
                ...
                self.is_lattice_planning = self.lattice.checkObject(self.path, global_npc_info, global_obs_info, lattice_path)
