...
from morai_msgs.msg import EgoVehicleStatus, ObjectStatusList, GetTrafficLightStatus, SetTrafficLight
...
class local_planner:
    def __init__(self):
        ...
        print (self.is_path, self.is_status, self.is_global_path)
...
class latticePlanner:
    def latticePlanner(self,ref_path, vehicle_status):
        ...
        look_distance = int(vehicle_velocity*0.9*2*10)
