...
def main():
    ...
    all_sprites.draw(screen)
    pg.display.set_caption('ERP42-Planning')
    pg.display.update()
    ...
    rospy.Subscriber("/ctrl_cmd", CtrlCmd, process_control_signal)
