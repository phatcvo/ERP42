...
def latticePlanner(ref_path,global_vaild_object,vehicle_status,current_lane):
    ...
    look_distance=int(vehicle_status[3]*3.6*0.8*5)*3
    print(look_distance)
    if look_distance < 5 :
    ...
    if len(ref_path.poses)>look_distance :
        ...
        add_point_size=int(vehicle_status[3]*2*3.6)*5
        ...
        lane_weight=[5,3,1,0.75,1,3,5]#reference path 
                    ...
                    for path_num in range(len(out_path)) :
                        ...
                        for path_pos in out_path[path_num].poses :
                            ...
                            if dis<1.5:
                                ...
                                lane_weight[path_num]=lane_weight[path_num]+10
                                break
        else :
            print("No Obstacle")
