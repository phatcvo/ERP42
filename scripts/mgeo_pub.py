...
class get_mgeo :
    ...
    def __init__(self):
        ...
        # is_find, self.path = self.path_planner.find_shortest_path('A119BS010229', 'A119BS010164')
        is_find, self.path = self.path_planner.find_shortest_path('A119BS010704','A119BS010189')
